		...
		deepCopy: vi.fn(() =>
			Effect.succeed({
				vm: {
					...
					// CRITICAL: Include stateManager for deepCopy defensive check (Issue #R130-P4-004)
					stateManager: {
						getAccount: vi.fn(() => Promise.resolve({ nonce: 0n, balance: 0n })),
						putAccount: vi.fn(() => Promise.resolve(undefined)),
						getCode: vi.fn(() => Promise.resolve(new Uint8Array())),
						putCode: vi.fn(() => Promise.resolve(undefined)),
						getStorage: vi.fn(() => Promise.resolve(new Uint8Array(32))),
						putStorage: vi.fn(() => Promise.resolve(undefined)),
						clearContractStorage: vi.fn(() => Promise.resolve(undefined)),
						checkpoint: vi.fn(() => Promise.resolve(undefined)),
						commit: vi.fn(() => Promise.resolve(undefined)),
						revert: vi.fn(() => Promise.resolve(undefined)),
						getStateRoot: vi.fn(() => Promise.resolve(new Uint8Array(32))),
						setStateRoot: vi.fn(() => Promise.resolve(undefined)),
						deepCopy: vi.fn(() => Promise.resolve({} as any)),
					},
				},
				runTx: vi.fn(() => Effect.succeed({} as any)),
