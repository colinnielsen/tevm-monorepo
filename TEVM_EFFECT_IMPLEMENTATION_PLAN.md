...
**FIXED CRITICAL Issues (1 total):**
- ✅ **#R130-P4-001**: FIXED - createdAddress now uses `bytesToHex(result.createdAddress.bytes)` for proper Hex type

**FIXED HIGH Issues (4 total):**
- ✅ **#R130-P2-001**: FIXED - VmShape typedef now includes `shallowCopy` method
- ✅ **#R130-P2-002**: FIXED - VmShape `ready` property now has VmError error channel in typedef
- ✅ **#R130-P2-003**: FIXED - ForkConfigFromRpc now has `@returns` JSDoc with typed ForkError error channel
- ✅ **#R130-P2-004**: FIXED - EvmLive deepCopy now uses `commonShape.common.copy()` for proper isolation
...
- 🟡 **#R130-P1-002**: effectToPromise service error detection may miss Effect error formats
- 🟡 **#R130-P1-007**: layerFromFactory no error handling guidance for factory failures
- 🟡 **#R130-P1-008**: LoggerLive no runtime guard for Node.js-only environment
- 🟡 **#R130-P1-012**: promiseToEffect missing catch handler unlike wrapWithEffect
- 🟡 **#R130-P1-017**: toTaggedError no validation for non-error inputs
- 🟡 **#R130-P1-019**: wrapWithEffect shallow copy can cause unexpected state sharing
- 🟡 **#R130-P2-005**: EvmLive shallowCopy binds methods to wrong `this` context
- 🟡 **#R130-P2-006**: BlockchainShape methods getCanonicalHeadBlock/getIteratorHead missing error channels
- 🟡 **#R130-P2-007**: BlockchainShape putBlock missing error channel
- 🟡 **#R130-P2-008**: BlockchainShape setIteratorHead missing error channel
- 🟡 **#R130-P2-009**: BlockchainShape ready missing error channel
- 🟡 **#R130-P2-010**: EvmLive accessing private `_customPrecompiles` via any cast
- 🟡 **#R130-P2-011**: EvmLive accessing private `optsCached.profiler` via any cast
- 🟡 **#R130-P2-012**: EvmLive copying DEBUG/_debug via any cast
- 🟡 **#R130-P2-013**: StateManagerLive Effect.runPromise in transport adapter - unhandled rejection risk
- 🟡 **#R130-P2-014**: BlockchainLive Effect.runPromise in transport adapter
- 🟡 **#R130-P3-001**: SetAccountLive storage values NOT padded to 32 bytes (keys are padded)
- 🟡 **#R130-P3-002**: FilterLive 7 @ts-expect-error suppressions - systematic type issue
- 🟡 **#R130-P3-003**: FilterLive incomplete deep copy for nested tx/blocks objects
- 🟡 **#R130-P3-009**: SnapshotLive catchAll after catchAllDefect may catch mapped errors
- 🟡 **#R130-P4-005**: MemoryClientLive dispose() is no-op with no resource cleanup
- 🟡 **#R130-P4-006**: EthActionsLive getBlockByNumber missing baseFeePerGas
- 🟡 **#R130-P4-007**: EthActionsLive getBlockByHash missing baseFeePerGas
- 🟡 **#R130-P4-008**: Miner address format not EIP-55 checksummed
- 🟡 **#R130-P4-009**: anvil_mine/evm_mine returns null instead of array (breaks Anvil/Hardhat compatibility)
- 🟡 **#R130-P4-010**: estimateGas does not apply blockTag parameter
- 🟡 **#R130-P4-011**: Missing withdrawalsRoot and blobGasUsed in block response

**NEW LOW Issues Found (29 total):**
- 🟢 **#R130-P1-003**: wrapWithEffect error type documentation could be clearer
- 🟢 **#R130-P1-004**: LoggerTest no log buffer size limit
- 🟢 **#R130-P1-005**: toTaggedError redundant errorMap iteration
- 🟢 **#R130-P1-006**: toBaseError custom `name` property may be lost
- 🟢 **#R130-P1-011**: toBaseError hardcoded VERSION constant
- 🟢 **#R130-P1-013**: LoggerService GenericTag string collision risk
- 🟢 **#R130-P1-015**: createManagedRuntime missing input validation
- 🟢 **#R130-P1-016**: LoggerTest `level: 'fatal'` silently captures nothing
- 🟢 **#R130-P1-018**: toBaseError null vs undefined semantics
- 🟢 **#R130-P2-015**: Blockchain iterator error classification fragile (string matching)
- 🟢 **#R130-P2-016**: StateManagerShape getStateRoot error uses placeholder stateRoot
- 🟢 **#R130-P2-017**: CommonLocal hardcodes mainnet chain ID
- 🟢 **#R130-P2-018**: VmLive return type uses typeof for services
- 🟢 **#R130-P2-019**: mapEvmError uses string matching for error classification
- 🟢 **#R130-P2-020**: BigInt parsing errors wrapped as ForkError
- 🟢 **#R130-P3-004**: SnapshotLive shallow copy of storage object
- 🟢 **#R130-P3-005**: SetAccountLive hexToBytes missing hex validation
- 🟢 **#R130-P3-006**: SetAccountLive validateHex allows empty hex strings
- 🟢 **#R130-P3-007**: FilterLive get() returns mutable reference
- 🟢 **#R130-P3-008**: SnapshotLive comment references removed code pattern
- 🟢 **#R130-P3-010**: GetAccountLive inconsistent isEmpty calculation
- 🟢 **#R130-P3-011**: SetAccountLive mapError vs nested Effect pattern
- 🟢 **#R130-P4-012**: Duplicate hexToBytes function definitions (3+ locations)
- 🟢 **#R130-P4-013**: Duplicate bytesToHex function definitions (6+ locations)
- 🟢 **#R130-P4-014**: commonCopy.copy() eips may share reference with original
- 🟢 **#R130-P4-015**: mine() uses common.common fragile coupling
- 🟢 **#R130-P4-016**: loadState missing JSON structure validation
- 🟢 **#R130-P4-017**: isValidAddress deprecated but still defined
- 🟢 **#R130-P4-018**: Missing return type annotations for several methods

**Open Issues Summary (Post 131st Fix):**
- **CRITICAL**: 0 ✅ (1 FIXED in 131st)
- **HIGH**: 3 🔴 (4 FIXED in 131st: #R130-P2-001, #R130-P2-002, #R130-P2-003, #R130-P2-004)
- **MEDIUM**: 165 (Previous 137 + 28 NEW)
- **LOW**: 380 (Previous 351 + 29 NEW)
...
- ✅ **#R126-P1-005**: FIXED - Verified from 126th review (all errorMap tags have specific handlers)
- ✅ **#R126-P2-004**: FIXED - Verified from 126th review (EvmShape has deepCopy/shallowCopy)
- ✅ **#R126-P3-002**: FIXED - FilterLive deepCopy now handles primitives correctly
- ✅ **#R126-P3-006**: FIXED - GetStorageAtLive hex validation added
- ✅ **#R126-P3-007**: FIXED - SetAccountLive hex validation added
- ✅ **#R126-P4-001**: FIXED - Verified from 126th review (EthActionsLive uses EvmService)

**NEW MEDIUM Issues Found (2 total - 2 FIXED):**
- ✅ **#R127-P1-001**: FIXED - ForkError now uses extractCodeFromCause static method with proper type guards
- ✅ **#R127-P3-001**: FIXED - FilterLive deepCopy now uses structuredClone for proper deep copying

**NEW LOW Issues Found (8 total):**
- 🟢 **#R127-P1-002**: DefensiveCopyError adds _tag in constructor but also inherits from Data.TaggedError - redundant
- 🟢 **#R127-P1-003**: errorAliases in toTaggedError could use Map for O(1) lookup instead of Object
- 🟢 **#R127-P2-001**: CommonShape inconsistent copy pattern - some fields copied inline, others not
- 🟢 **#R127-P2-002**: VmLive Layer error channel not declared in return type
- 🟢 **#R127-P2-003**: BlockchainLive getBlock* methods use `as any` type assertion
- 🟢 **#R127-P3-002**: ActionParamsLive validation could use Effect.all for parallel validation
- 🟢 **#R127-P4-001**: BlockBuilderLive mine() bypasses Effect patterns - direct Promise usage
- 🟢 **#R127-P4-002**: EthActionsLive getBlock*/getLogs error swallowing on empty results

**STILL OPEN from 126th Review:**
- 🟡 **#R126-P1-003**: toBaseError returns Error instance but typed as BaseErrorLike
- 🟡 **#R126-P1-006**: layerFromFactory error wrapped in UnknownException
- 🟡 **#R126-P2-001**: StateManagerLive duplicates createShape
- 🟡 **#R126-P2-003**: StateManagerShape typedef missing error channels on 16 methods
- 🟡 **#R126-P2-005**: BlockchainLive and StateManagerLive have duplicated error enrichment logic
- 🟡 **#R126-P2-006**: VmShape missing shallowCopy method
- 🟡 **#R126-P4-002**: MemoryClientLive dispose is a no-op
- ✅ **#R126-P4-004**: FIXED - RequestLive now includes snapshot/revert JSON-RPC methods (anvil_snapshot, evm_snapshot, anvil_revert, evm_revert)
...
### 130TH REVIEW (2026-02-04) - Deep Parallel Opus 4.5 Ultrathink Comprehensive Review

**Reviewed By**: Claude Opus 4.5 (4 parallel subagents reviewing each phase independently with ultrathink)
**Scope**: Complete independent deep dive review of all 4 phases to find NEW bugs missed by 129 previous reviews

---

#### Phase 1: 0 CRITICAL + 0 HIGH + 7 MEDIUM + 9 LOW NEW Issues Found

##### Issue #R130-P1-001: Inconsistent `name` property in super() call across error classes
**File:Lines**: `packages/errors-effect/src/state/StateRootNotFoundError.js + 4 others`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: 5 error classes include `name` in the object passed to `super()`, while the majority do not. Effect.ts uses properties passed to super() for equality/hashing.

**Impact**: Subtle bugs in Effect.ts equality comparisons between error types with different super() patterns.

---

##### Issue #R130-P1-002: effectToPromise service error detection may miss Effect error formats
**File:Lines**: `packages/interop/src/effectToPromise.js:116-118`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Service error detection relies on string matching ('Service not found', 'is not available'). Effect.ts error formats may change between versions.

**Impact**: Some service access errors may not be caught, leading to less helpful error messages.

---

##### Issue #R130-P1-007: layerFromFactory no error handling guidance for factory failures
**File:Lines**: `packages/interop/src/layerFromFactory.js`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Function doesn't document or handle the case when the factory function throws or rejects. Errors are wrapped in UnknownException.

**Impact**: Debugging factory failures is harder due to lost error type information.

---

##### Issue #R130-P1-008: LoggerLive no runtime guard for Node.js-only environment
**File:Lines**: `packages/logger-effect/src/LoggerLive.js:28-31`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: LoggerLive uses Pino which requires Node.js and `process.stdout`. No environment check upfront.

**Impact**: Browser users see cryptic "process is not defined" errors instead of clear guidance.

---

##### Issue #R130-P1-012: promiseToEffect missing catch handler unlike wrapWithEffect
**File:Lines**: `packages/interop/src/promiseToEffect.js:74-82`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Uses `Effect.tryPromise()` without custom catch handler, wrapping errors in UnknownException. `wrapWithEffect` preserves original errors with `catch: (error) => error`.

**Impact**: Inconsistent error handling patterns between interop functions.

---

##### Issue #R130-P1-017: toTaggedError no validation for non-error inputs
**File:Lines**: `packages/errors-effect/src/interop/toTaggedError.js:128`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Function accepts any input without validating it's actually an error-like object.

**Impact**: Passing non-error objects (null, strings, numbers) may produce confusing behavior.

---

##### Issue #R130-P1-019: wrapWithEffect shallow copy can cause unexpected state sharing
**File:Lines**: `packages/interop/src/wrapWithEffect.js:103-108`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Object.assign creates a shallow copy. Nested objects in the wrapped instance share references.

**Impact**: Mutations to nested properties affect both original and wrapped object.

---

#### Phase 2: 0 CRITICAL + 4 HIGH + 10 MEDIUM + 6 LOW NEW Issues Found

##### Issue #R130-P2-001: VmShape typedef missing `shallowCopy` method
**File:Lines**: `packages/vm-effect/src/types.js:20-27`
**Severity**: 🔴 HIGH
**Status**: 🟡 NEW

**Problem**: VmShape defines `deepCopy` but NOT `shallowCopy`, while all other Phase 2 service shapes (BlockchainShape, EvmShape, StateManagerShape) include both methods.

**Impact**: API inconsistency. Consumers expecting `shallowCopy` on VmShape will encounter runtime errors.

---

##### Issue #R130-P2-002: VmShape `ready` property missing error channel in typedef
**File:Lines**: `packages/vm-effect/src/types.js:25`
**Severity**: 🔴 HIGH
**Status**: 🟡 NEW

**Problem**: The `ready` property is declared as `Effect.Effect<void>` without error channel, but implementation in VmLive.js:122-125 uses `Effect.tryPromise` with `mapEvmError` which can fail with `EvmError`.

**Impact**: Type mismatch - consumers may not properly handle errors from the `ready` effect.

---

##### Issue #R130-P2-003: ForkConfigFromRpc Layer missing typed error channel annotation
**File:Lines**: `packages/transport-effect/src/ForkConfigFromRpc.js:64-101`
**Severity**: 🔴 HIGH
**Status**: 🟡 NEW

**Problem**: ForkConfigFromRpc Layer can fail with `ForkError` during RPC requests, but there is no `@returns` or `@type` annotation declaring this error channel.

**Impact**: Consumers cannot properly type their error handling when providing this layer.

---

##### Issue #R130-P2-004: EvmLive deepCopy reuses `commonShape.common` instead of copying
**File:Lines**: `packages/evm-effect/src/EvmLive.js:137`
**Severity**: 🔴 HIGH
**Status**: 🟡 NEW

**Problem**: In `EvmLive.deepCopy()`, when creating a deep copy, the code copies `stateManager` and `blockchain` but reuses the same `commonShape.common` reference instead of creating a copy.

**Impact**: The "deep copied" EVM shares the same `Common` instance with the original. If either mutates the common (e.g., changing hardfork), both are affected. Violates deep copy semantics.

---

##### Issue #R130-P2-005: EvmLive shallowCopy binds methods to wrong `this` context
**File:Lines**: `packages/evm-effect/src/EvmLive.js:160-161`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: `shallowCopy()` binds `addCustomPrecompile` and `removeCustomPrecompile` from `evmInstance` to `evmCopy`, but method behavior may depend on original instance properties.

**Impact**: Copied EVM's precompile methods may access wrong internal state.

---

##### Issue #R130-P2-006: BlockchainShape methods getCanonicalHeadBlock/getIteratorHead missing error channels
**File:Lines**: `packages/blockchain-effect/src/types.js:32-33`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: These methods are declared without error channels, but implementations use `Effect.tryPromise` which can fail with `BlockNotFoundError`.

**Impact**: Type mismatch between declaration and implementation.

---

##### Issue #R130-P2-007: BlockchainShape putBlock missing error channel
**File:Lines**: `packages/blockchain-effect/src/types.js:31`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: putBlock method declared without error channel but implementation throws `InvalidBlockError`.

---

##### Issue #R130-P2-008: BlockchainShape setIteratorHead missing error channel
**File:Lines**: `packages/blockchain-effect/src/types.js:34`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: setIteratorHead method declared without error channel but implementation uses `Effect.tryPromise`.

---

##### Issue #R130-P2-009: BlockchainShape ready missing error channel
**File:Lines**: `packages/blockchain-effect/src/types.js:39`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: `ready` property declared as `Effect.Effect<void>` but implementations can fail with `InvalidBlockError`.

---

##### Issue #R130-P2-010: EvmLive accessing private `_customPrecompiles` via any cast
**File:Lines**: `packages/evm-effect/src/EvmLive.js:141`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Accesses `evmInstance._customPrecompiles` via `any` cast - an internal/private property.

**Impact**: Coupling to internal implementation. If property name changes, deepCopy silently fails to copy precompiles.

---

##### Issue #R130-P2-011: EvmLive accessing private `optsCached.profiler` via any cast
**File:Lines**: `packages/evm-effect/src/EvmLive.js:143`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Accesses internal property `optsCached?.profiler?.enabled` via `any` cast.

---

##### Issue #R130-P2-012: EvmLive copying DEBUG/_debug via any cast
**File:Lines**: `packages/evm-effect/src/EvmLive.js:149-151`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Copies private debugging properties via `any` casts without proper typing.

---

##### Issue #R130-P2-013: StateManagerLive Effect.runPromise in transport adapter - unhandled rejection risk
**File:Lines**: `packages/state-effect/src/StateManagerLive.js:100-123`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Transport adapter uses `Effect.runPromise` to convert Effect to Promise. If fiber is cancelled, these in-flight promises may cause unhandled rejection errors.

**Impact**: Resource cleanup issues during fiber cancellation.

---

##### Issue #R130-P2-014: BlockchainLive Effect.runPromise in transport adapter
**File:Lines**: `packages/blockchain-effect/src/BlockchainLive.js:94-113`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Same as #R130-P2-013 - same pattern in BlockchainLive.

---

#### Phase 3: 0 CRITICAL + 0 HIGH + 4 MEDIUM + 7 LOW NEW Issues Found

##### Issue #R130-P3-001: SetAccountLive storage values NOT padded to 32 bytes
**File:Lines**: `packages/actions-effect/src/SetAccountLive.js:337`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Storage keys are padded to 32 bytes (`hexToBytes(key, { size: 32 })`), but storage values are NOT padded (`hexToBytes(value)` has no size option). EVM storage slots are 256-bit words.

**Impact**: Inconsistent storage representation; underlying state trie may behave differently across implementations.

---

##### Issue #R130-P3-002: FilterLive 7 @ts-expect-error suppressions - systematic type issue
**File:Lines**: `packages/node-effect/src/FilterLive.js:167,212,257,302,342,383`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Seven `@ts-expect-error` comments suppress TypeScript errors on `Ref.modify` return type inference. Indicates systematic pattern issue.

**Impact**: Type suppressions may hide actual type mismatches. If API changes, errors won't be caught.

---

##### Issue #R130-P3-003: FilterLive incomplete deep copy for nested tx/blocks objects
**File:Lines**: `packages/node-effect/src/FilterLive.js:504-511`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: deepCopy for tx and blocks arrays only does shallow spreading. Transactions have `accessList`, blocks have `transactions` arrays - nested objects share references.

**Impact**: Modifying nested property in copy affects original.

---

##### Issue #R130-P3-009: SnapshotLive catchAll after catchAllDefect may catch mapped errors
**File:Lines**: `packages/node-effect/src/SnapshotLive.js:217-223`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Error handling chain has `catchAllDefect` followed by `catchAll`. If StateRootNotFoundError created in catchAllDefect fails, catchAll catches and re-wraps it.

**Impact**: Complex error handling paths that may obscure original error source.

---

#### Phase 4: 1 CRITICAL + 3 HIGH + 7 MEDIUM + 7 LOW NEW Issues Found

##### Issue #R130-P4-001: createdAddress type mismatch - CRITICAL
**File:Lines**: `packages/decorators-effect/src/TevmActionsLive.js:177`, `packages/decorators-effect/src/types.js:142`
**Severity**: 🔴 CRITICAL
**Status**: 🟡 NEW

**Problem**: `createdAddress` in `TevmCallResult` is typed as `Hex` (`0x${string}`) in types.js:142, but TevmActionsLive.js:177 uses `result.createdAddress?.toString()` which returns plain `string`, not `Hex` type.

**Impact:** Type safety violation. Consumers expecting `0x${string}` may receive non-prefixed string. Could cause address validation failures in downstream code.

---

##### Issue #R130-P4-002: Missing critical JSON-RPC methods in RequestLive
**File:Lines**: `packages/decorators-effect/src/RequestLive.js`
**Severity**: 🔴 HIGH
**Status**: 🟡 NEW

**Problem**: Missing critical Ethereum JSON-RPC methods:
...
**Impact**: Clients expecting full JSON-RPC compliance encounter `MethodNotFoundError`. Severely limits usability.
...
##### Issue #R130-P4-005: MemoryClientLive dispose() is no-op with no resource cleanup
**File:Lines**: `packages/memory-client-effect/src/MemoryClientLive.js:753-756`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: dispose() method is empty no-op. Network connections, state caches, event listeners are not cleaned up.

**Impact**: Resource leaks in long-running applications or rapid client creation/destruction.

---

##### Issue #R130-P4-006: EthActionsLive getBlockByNumber missing baseFeePerGas
**File:Lines**: `packages/decorators-effect/src/EthActionsLive.js:380-453`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Block response does not include `baseFeePerGas` field required for EIP-1559 blocks.

**Impact**: EIP-1559 fee estimation fails. Affects DeFi applications and gas estimation tooling.

---

##### Issue #R130-P4-007: EthActionsLive getBlockByHash missing baseFeePerGas
**File:Lines**: `packages/decorators-effect/src/EthActionsLive.js:455-528`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Same as #R130-P4-006 - getBlockByHash also missing baseFeePerGas.

---

##### Issue #R130-P4-008: Miner address format not EIP-55 checksummed
**File:Lines**: `packages/decorators-effect/src/EthActionsLive.js:414,489`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Miner/coinbase address converted to lowercase without EIP-55 checksum.

**Impact**: Returns lowercase addresses which may fail EIP-55 validation in strict clients.

---

##### Issue #R130-P4-009: anvil_mine/evm_mine returns null instead of array
**File:Lines**: `packages/decorators-effect/src/RequestLive.js:272-279`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: `anvil_mine` and `evm_mine` return `null`, but Anvil/Hardhat standard returns `0x0` or array of block hashes.

**Impact**: Breaks compatibility with Hardhat, Foundry, Web3.js tooling.

---

##### Issue #R130-P4-010: estimateGas does not apply blockTag parameter
**File:Lines**: `packages/decorators-effect/src/EthActionsLive.js:246-378`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: estimateGas implementation doesn't accept or use blockTag parameter for historical state estimation.

**Impact**: Cannot estimate gas for historical block states. Affects replay protection analysis.

---

##### Issue #R130-P4-011: Missing withdrawalsRoot and blobGasUsed in block response
**File:Lines**: `packages/decorators-effect/src/EthActionsLive.js:380-453`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Post-Shanghai blocks require `withdrawalsRoot`, post-Cancun require `blobGasUsed` and `excessBlobGas`. Not included.

**Impact**: Clients querying recent blocks receive incomplete data.

---

#### 130th Review Summary Table
...
| **Phase 3** | 0 | 0 | 4 | 7 | 11 |
| **Phase 4** | 1 | 3 | 7 | 7 | 18 |
| **TOTAL NEW** | **1** | **7** | **28** | **29** | **65** |

**Key Findings:**
1. **CRITICAL Issue**: createdAddress type mismatch could cause runtime failures in contract deployment flows
2. **HIGH Issues**: VmShape missing shallowCopy, ready property missing error channel, common not copied in deepCopy, missing JSON-RPC methods, blockchain/stateManager inconsistency after deepCopy
3. **Patterns Identified**:
   - Typedef error channels not matching implementations across multiple packages
   - Private property access via `any` casts in evm-effect
   - Missing EIP-1559/Cancun block fields in JSON-RPC responses
   - Inconsistent error handling patterns in interop functions
...
### 127TH REVIEW (2026-02-02) - Parallel Opus 4.5 Verification Review

**Reviewed By**: Claude Opus 4.5 (4 parallel subagents verifying each phase independently)
**Scope**: Verification of 126th review fixes + discovery of new issues

---

#### Phase 1: 1 MEDIUM + 2 LOW NEW Issues Found | 2 Issues Verified FIXED

##### Issue #R126-P1-001: AccountNotFoundError Inconsistent super() Call
**Status**: ✅ FIXED - AccountNotFoundError now matches pattern of other error classes

##### Issue #R126-P1-005: toTaggedError ErrorClass Lookup Not Used as Fallback
**Status**: ✅ FIXED - Verified from 126th review (all errorMap tags have specific handlers)

##### Issue #R127-P1-001: ForkError Dynamic Code Extraction
**File:Lines**: `packages/errors-effect/src/transport/ForkError.js:45-65`
**Severity**: 🟡 MEDIUM
**Status**: ✅ FIXED

**Problem**: ForkError constructor dynamically extracts `code` property from cause using `cause?.code`. This fragile pattern assumes cause structure, which may break if upstream error shapes change.

**Impact**: If cause structure changes, code extraction silently fails (returns undefined), potentially losing error context.

**Fix Applied**: Added `extractCodeFromCause` static method with proper type guards to safely extract code from cause. The method checks: (1) if cause is non-null and is an object, (2) if cause has a 'code' property, (3) if the code property is a number. Falls back to default code (-32604) if any check fails. Full test coverage added.

---

##### Issue #R127-P1-002: DefensiveCopyError Redundant _tag
**File:Lines**: `packages/errors-effect/src/copy/DefensiveCopyError.js:25-30`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW

**Problem**: DefensiveCopyError manually sets `_tag` in constructor but also extends Data.TaggedError which automatically provides `_tag`.

**Impact**: Redundant code. No functional issue but inconsistent with other errors.

---

##### Issue #R127-P1-003: errorAliases Object vs Map
**File:Lines**: `packages/errors-effect/src/interop/toTaggedError.js:12-45`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW

**Problem**: `errorAliases` uses plain Object for lookups. For large alias sets, a Map would provide O(1) lookup guarantees.

**Impact**: Minor performance. Object lookup is O(1) average case but Map is more explicit.

---

#### Phase 2: 3 LOW NEW Issues Found | 1 Issue Verified FIXED

##### Issue #R126-P2-004: EvmShape Missing deepCopy/shallowCopy
**Status**: ✅ FIXED - Verified from 126th review (EvmShape now has deepCopy/shallowCopy methods)

##### Issue #R127-P2-001: CommonShape Inconsistent Copy Pattern
**File:Lines**: `packages/common-effect/src/CommonLive.js:78-95`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW

**Problem**: CommonShape deepCopy copies some fields inline while others use method delegation. Pattern is inconsistent with other service shapes.

**Impact**: Minor maintainability concern. May cause confusion when adding new fields.

---

##### Issue #R127-P2-002: VmLive Layer Error Channel Not Declared
**File:Lines**: `packages/vm-effect/src/VmLive.js:45-52`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW

**Problem**: VmLive Layer return type doesn't explicitly declare error channel in type signature.

**Impact**: Consumers may not know what errors can occur during Layer construction.

---

##### Issue #R127-P2-003: BlockchainLive Type Assertions
**File:Lines**: `packages/blockchain-effect/src/BlockchainLive.js:112-125`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW

**Problem**: getBlock and getBlockByTag methods use `as any` type assertions to work around type mismatches.

**Impact**: Type safety reduced. Could mask real type errors if Block types change.

---

#### Phase 3: 1 MEDIUM + 1 LOW NEW Issues Found | 3 Issues Verified FIXED

##### Issue #R126-P3-002: FilterLive deepCopy Spreads Primitives Incorrectly
**Status**: ✅ FIXED - FilterLive deepCopy now handles primitives correctly with proper type checks

##### Issue #R126-P3-006: GetStorageAtLive hexToBytes Validation
**Status**: ✅ FIXED - Hex character validation added before conversion

##### Issue #R126-P3-007: SetAccountLive hexToBytes Validation
**Status**: ✅ FIXED - Hex character validation added for security

##### Issue #R127-P3-001: FilterLive Nested Spread Pattern
**File:Lines**: `packages/actions-effect/src/filters/FilterLive.js:156-172`
**Severity**: 🟡 MEDIUM
**Status**: ✅ FIXED

**Problem**: FilterLive deepCopy uses nested spread pattern `{ ...{ ...obj } }` which doesn't actually deep copy nested objects - only creates shallow copies at each spread level.

**Impact**: Mutations to nested properties of copied objects may still affect originals, violating defensive copy guarantee.

**Fix Applied**: Replaced nested spread pattern with `structuredClone()` for proper deep copying of nested objects. This ensures full defensive copy guarantee as per RFC requirements.

---

##### Issue #R127-P3-002: ActionParamsLive Sequential Validation
**File:Lines**: `packages/actions-effect/src/params/ActionParamsLive.js:45-78`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW

**Problem**: Parameter validation runs sequentially. Could use Effect.all with concurrent option for parallel validation.

**Impact**: Minor performance. Validation is fast but parallel would be optimal.

---

#### Phase 4: 2 LOW NEW Issues Found | 1 Issue Verified FIXED

##### Issue #R126-P4-001: EthActionsLive Uses EvmService Abstraction
**Status**: ✅ FIXED - Verified from 126th review (EthActionsLive now uses EvmService for runCall)

##### Issue #R127-P4-001: BlockBuilderLive Direct Promise Usage
**File:Lines**: `packages/decorators-effect/src/BlockBuilderLive.js:89-102`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW

**Problem**: BlockBuilderLive mine() method uses direct Promise chains instead of Effect patterns. This bypasses Effect's error handling and resource management.

**Impact**: Inconsistent with RFC principles. Errors may not be properly typed.

---

##### Issue #R127-P4-002: EthActionsLive Error Swallowing
**File:Lines**: `packages/decorators-effect/src/EthActionsLive.js:234-256`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW

**Problem**: getBlockByHash and getLogs return empty results instead of errors when underlying operations fail. This swallows errors silently.

**Impact**: Debugging difficult when operations fail - appears as empty data instead of error.
...
**File:Lines**: `packages/decorators-effect/src/RequestLive.js:62-315`
**Severity**: 🟡 MEDIUM
...
**Fix Applied**: Added snapshot/revert methods (anvil_snapshot, evm_snapshot, anvil_revert, evm_revert) to RequestLive. Full test coverage added. Transaction/log methods still pending but snapshot/revert critical for testing workflows.
...
### 125TH REVIEW (2026-02-02) - Deep Parallel Opus 4.5 Review

**Reviewed By**: Claude Opus 4.5 (4 parallel subagents reviewing each phase independently)
**Scope**: Complete independent deep dive review of all 4 phases with RFC compliance verification

---

#### Phase 1: 2 HIGH + 3 MEDIUM + 2 LOW NEW Issues Found

##### Issue #R125-P1-001: promiseToEffect Error Type Silently Lost
**File:Lines**: `packages/interop/src/promiseToEffect.js:81`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Uses `Effect.tryPromise(() => fn(...args))` without custom `catch` handler, so errors are wrapped in Effect's `UnknownException`. Meanwhile, `wrapWithEffect` uses `catch: (error) => error` to preserve original error.

**Impact**: Inconsistent error handling patterns between interop functions.

**Recommended Fix**: Add explicit error handling: `Effect.tryPromise({ try: () => fn(...args), catch: (error) => error })`
...
##### Issue #R125-P1-003: LoggerTest('silent') Misleading API
**File:Lines**: `packages/logger-effect/src/LoggerTest.js:46-54,172-174`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: LoggerTest accepts 'silent' level but captures nothing because silent has priority 6 (highest). Tests using `LoggerTest('silent')` will pass but log assertions fail mysteriously.

**Impact**: Confusing test failures when using 'silent' level with test logger.

**Recommended Fix**: Throw error when 'silent' is passed, or exclude 'silent' from LoggerTest's accepted levels.

---

##### Issue #R125-P1-004: toTaggedError Duplicate Iteration for Aliases
**File:Lines**: `packages/errors-effect/src/interop/toTaggedError.js:137-141`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Iterates through `Object.values(errorMap)` which includes duplicate classes for aliases (e.g., `Revert` and `RevertError` both point to `RevertError`).

**Impact**: Minor performance overhead, potential issues with class hierarchy checks.

**Recommended Fix**: Use `new Set(Object.values(errorMap))` before iteration.

---

##### Issue #R125-P1-005: toBaseError Template Type Too Narrow
**File:Lines**: `packages/errors-effect/src/interop/toBaseError.js:97-99`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Template type only lists subset of error types (InsufficientBalanceError, OutOfGasError, RevertError, etc.), excluding ForkError, NetworkError, TimeoutError, BlockNotFoundError, and many others from TevmTaggedErrorUnion.

**Impact**: TypeScript errors when passing other valid error types to `toBaseError`.

**Recommended Fix**: Import and use `TevmTaggedErrorUnion` from toTaggedError.types.js.

---

##### Issue #R125-P1-006: wrapWithEffect State Divergence Counter-Intuitive
**File:Lines**: `packages/interop/src/wrapWithEffect.js:94-99,102-108`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW (Documented but still concern)

**Problem**: Effect methods bound to original instance via closure. Mutations to wrapped object don't affect Effect method behavior. While documented, this is counter-intuitive.

**Impact**: Potential source of bugs when state is modified on wrapped object.

**Recommended Fix**: Consider Proxy pattern or rename to `wrapWithEffectImmutable` for clarity.

---

##### Issue #R125-P1-007: layerFromFactory Missing Parameter Validation
**File:Lines**: `packages/interop/src/layerFromFactory.js:57-63`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW

**Problem**: Unlike `promiseToEffect` which validates inputs, `layerFromFactory` doesn't validate `tag` or `factory` parameters.

**Impact**: Delayed error discovery if factory is undefined.

**Recommended Fix**: Add validation similar to promiseToEffect.

---

#### Phase 2: 0 HIGH + 4 MEDIUM + 4 LOW NEW Issues Found

##### Issue #R125-P2-401: VmShape.ready Missing Error Type (Reconfirmed)
**File:Lines**: `packages/vm-effect/src/types.js:25`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW (Reconfirmed from 123rd review)

**Problem**: Typed as `Effect<void>` but implementation returns `Effect<void, VmError>`.

---

##### Issue #R125-P2-402: BlockchainShape.ready Missing Error Type (Reconfirmed)
**File:Lines**: `packages/blockchain-effect/src/types.js:40`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW (Reconfirmed)

**Problem**: Typed as `Effect<void>` but implementation can fail with `InvalidBlockError`.

---

##### Issue #R125-P2-403: StateManagerShape.ready Missing Error Type (Reconfirmed)
**File:Lines**: `packages/state-effect/src/types.js:45`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW (Reconfirmed)

**Problem**: Typed as `Effect<void>` but can fail with `NodeNotReadyError`.

---

##### Issue #R125-P2-404: VmShape.deepCopy Missing Error Type
**File:Lines**: `packages/vm-effect/src/types.js:26`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Typed as `Effect<VmShape>` but implementation wraps in `Effect.tryPromise` with error mapping.

---

##### Issue #R125-P2-001: BlockchainLive blockId Cast Excludes 'forked'
**File:Lines**: `packages/blockchain-effect/src/BlockchainLive.js:156-159`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW

**Problem**: Cast does not include 'forked' though types.js defines it as valid BlockTag.

---

##### Issue #R125-P2-002: ForkConfigFromRpc Error Channel Undocumented
**File:Lines**: `packages/transport-effect/src/ForkConfigFromRpc.js:64-101`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW

**Problem**: Layer can fail with ForkError but this is not documented in JSDoc.

---

##### Issue #R125-P2-003: HttpTransport Batched Shutdown TOCTOU
**File:Lines**: `packages/transport-effect/src/HttpTransport.js:422-438`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW (Has Mitigation)

**Problem**: Potential TOCTOU issue during shutdown. Mitigated by existing defensive code at lines 445-457.

---

##### Issue #R125-P2-004: EvmShape Exposes Raw evm Instance
**File:Lines**: `packages/evm-effect/src/types.js:11-29`
**Severity**: 🟢 LOW (Informational)
**Status**: 🟡 NEW

**Problem**: Exposes underlying implementation, breaking service abstraction. Users may bypass Effect-wrapped methods.

---

#### Phase 3: 0 CRITICAL + 0 HIGH + 1 MEDIUM + 6 LOW NEW Issues Found

##### Issue #R125-P3-001: FilterLive deepCopy May Fail on Primitives
**File:Lines**: `packages/node-effect/src/FilterLive.js:505-507`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: When deep copying `tx` and `blocks` arrays, spreads each element as object. If arrays contain primitives (hex strings), spread fails or produces unexpected results.

**Impact**: Runtime error or incorrect data if blocks/tx arrays contain primitive values.

**Recommended Fix**: Check if element is object before spreading: `tx: filter.tx.map((t) => (typeof t === 'object' && t !== null ? { ...t } : t))`

---

##### Issue #R125-P3-002: SnapshotLive takeSnapshot Ref.update After Commit
**File:Lines**: `packages/node-effect/src/SnapshotLive.js:143-150`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW

**Problem**: Ref.update happens AFTER commit succeeds. If this fails (memory issue, fiber interrupted), snapshot ID was returned but data is lost.

**Impact**: Very rare edge case - snapshot ID returned but snapshot doesn't exist.

---

##### Issue #R125-P3-003: SnapshotLive deepCopy No StateManager Validation
**File:Lines**: `packages/node-effect/src/SnapshotLive.js:255-297`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW

**Problem**: When caller provides `newStateManager`, function doesn't validate it's in same state as original.

---

##### Issue #R125-P3-004: FilterLive deepCopy Topics Null Handling
**File:Lines**: `packages/node-effect/src/FilterLive.js:493-497`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW

**Problem**: Complex ternary may behave unexpectedly if `topics` is `null` rather than `undefined`.

---

##### Issue #R125-P3-005: GetStorageAtLive hexToBytes No Hex Validation
**File:Lines**: `packages/actions-effect/src/GetStorageAtLive.js:41-52`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW

**Problem**: Doesn't explicitly check for invalid hex characters like SnapshotLive does. Invalid characters via Number.parseInt return NaN -> 0.

**Impact**: Silent data corruption if invalid hex passed.

---

##### Issue #R125-P3-006: SetAccountLive hexToBytes Missing Hex Validation
**File:Lines**: `packages/actions-effect/src/SetAccountLive.js:19-30`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW

**Problem**: Same as #R125-P3-005. Note: validateHex at lines 76-98 does check format with regex, mitigating this.

---

##### Issue #R125-P3-007: SetAccountLive Storage Value Rejects "0x"
**File:Lines**: `packages/actions-effect/src/SetAccountLive.js:327-335`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW

**Problem**: Regex `/^0x[a-fA-F0-9]+$/` requires at least one hex digit after `0x`. Value `"0x"` (empty hex) fails validation but is valid representation for zero/empty storage.

**Recommended Fix**: Change to `/^0x[a-fA-F0-9]*$/` (asterisk instead of plus).

---

#### Phase 4: 0 CRITICAL (1 FIXED) + 3 HIGH + 3 MEDIUM + 1 LOW NEW Issues Found

##### Issue #R125-P4-001: DeepCopy State Inconsistency Between VM and StateManager
**File:Lines**: `packages/memory-client-effect/src/MemoryClientLive.js:706-742`
**Severity**: 🔴 CRITICAL
**Status**: ✅ FIXED (2026-02-02)

**Problem**: The `deepCopy` implementation creates separate copies of `stateManager` and `vm`, but the VM internally creates its own stateManager copy during `VM.deepCopy()`. This results in TWO different stateManager instances:
1. `stateManagerCopy` - used by action services (getAccount, setAccount, getBalance, getCode, getStorageAt)
2. `vmCopy.vm.stateManager` - used internally by the VM for EVM execution
...
**Impact**: After calling `deepCopy()`, if a user:
1. Calls `setAccount()` to modify state (uses `stateManagerCopy`)
2. Then calls an EVM execution method like `tevm_call` via the VM (uses `vmCopy.vm.stateManager`)

The EVM execution will NOT see the state changes made via `setAccount()`. This is a data consistency bug that could lead to incorrect execution results.

**Recommended Fix**: Either:
1. Pass the `stateManagerCopy` to the VM during deepCopy so both use the same instance, or
2. Ensure VM.deepCopy() accepts an external stateManager parameter

**Fix Applied**: Created `createStateManagerShape` factory function in `@tevm/state-effect/wrapStateManager.js` that creates a `StateManagerShape` from any raw `StateManager` instance. Modified `MemoryClientLive.deepCopy()` to:
1. Only call `vm.deepCopy()` (which creates its own internal stateManager copy)
2. Extract the stateManager from the copied VM via `vmCopy.vm.stateManager`
3. Wrap it using `createStateManagerShape()` to create the `StateManagerShape`

This ensures both VM and action services use the SAME stateManager instance. Also refactored `StateManagerLocal.js` to use the shared factory, eliminating ~200 lines of duplicated code. Added 37 tests to `wrapStateManager.spec.ts` with 100% coverage
...
##### Issue #R125-P4-005: EthActionsLive Incomplete EVM Error Mapping
**File:Lines**: `packages/decorators-effect/src/EthActionsLive.js:186-222`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: Only handles revert, out of gas, invalid opcode. Stack underflow, stack overflow, invalid jump, static state change all mapped to generic InternalError.

**Recommended Fix**: Extend error mapping to cover all EVM error types from RFC 6.1.

---

##### Issue #R125-P4-006: createDeepCopyClient Potential Memory Leak
**File:Lines**: `packages/memory-client-effect/src/createMemoryClient.js:184-200`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: If `createDeepCopyClient` throws after `copiedRuntime` is created, dispose is fire-and-forget. Original error thrown before disposal completes.

**Impact**: Runtime may not be properly cleaned up, leading to resource leaks.

---

##### Issue #R125-P4-007: TevmCallResult.createdAddress Type Mismatch
**File:Lines**: `packages/decorators-effect/src/types.js:82-89`, `TevmActionsLive.js:168`
**Severity**: 🟡 MEDIUM
**Status**: 🟡 NEW

**Problem**: `createdAddress` typed as `Hex` but implementation returns `result.createdAddress?.toString()` which may not return hex format with `0x` prefix.

---

##### Issue #R125-P4-008: Common Copy Method Self-Reference Pattern
**File:Lines**: `packages/memory-client-effect/src/MemoryClientLive.js:721-731`
**Severity**: 🟢 LOW
**Status**: 🟡 NEW

**Problem**: `commonCopy` references itself before fully initialized (works due to JavaScript hoisting but confusing).

---

#### Summary Table (125th Review)
